...
public class SpecialAbilityZone : MonoBehaviour
{
    ...
    private void UpdateVisual(float lifetimePercent)
    {
        ...
        float widthMultiplier = zoneType == ZoneType.IceNova || zoneType == ZoneType.TimeFracture
            ? Mathf.Lerp(1.25f, 0.2f, lifetimePercent)
            : Mathf.Lerp(1f, 0.4f, lifetimePercent);
