...
public class EliteWarningToastUI : MonoBehaviour
{
    [Header("Text")]
    [SerializeField] private string titleText = "ELITE DETECTED";
    [SerializeField] private string subtitleText = "HIGH-VALUE TARGET APPROACHING";

    [Header("Layout")]
    [SerializeField] private Vector2 panelSize = new Vector2(520f, 118f);
    [SerializeField] private Vector2 panelAnchoredPosition = new Vector2(0f, -115f);

    [Header("Colors")]
    [SerializeField] private Color panelColor = new Color(0.06f, 0.02f, 0.02f, 0.86f);
    [SerializeField] private Color sideBarColor = new Color(1f, 0.25f, 0.08f, 1f);
    [SerializeField] private Color titleColor = new Color(1f, 0.38f, 0.16f, 1f);
    [SerializeField] private Color eliteNameColor = Color.white;
    [SerializeField] private Color subtitleColor = new Color(1f, 0.78f, 0.36f, 1f);

    [Header("Text Sizes")]
    [SerializeField] private int titleFontSize = 24;
    [SerializeField] private int eliteNameFontSize = 31;
    ...
    private Text eliteNameTextComponent;
    ...
    public Coroutine ShowWarning(string eliteName, float duration)
    {
        ...
        activeRoutine = StartCoroutine(PlayWarningRoutine(eliteName, duration));
        return activeRoutine;
    }

    public IEnumerator PlayWarningRoutine(string eliteName, float duration)
    {
        BuildUI();

        if (string.IsNullOrEmpty(eliteName))
        {
            eliteName = "ELITE ENEMY";
        }

        titleTextComponent.text = titleText;
        eliteNameTextComponent.text = eliteName.ToUpper();
    ...
    private void BuildUI()
    {
        ...
        if (canvas == null)
        {
            GameObject canvasObject = new GameObject("Elite Warning Toast Canvas");
        ...
        GameObject rootObject = new GameObject("Elite Warning Toast Root");
        ...
        GameObject panelObject = new GameObject("Elite Warning Panel");
        ...
        GameObject sideBarObject = new GameObject("Warning Side Bar");
        ...
        eliteNameTextComponent = CreateText(
            textColumnObject.transform,
            "Elite Name Text",
            "ELITE BRUTE",
            eliteNameFontSize,
