...
public class UpgradeManager : MonoBehaviour
{
    ...
    private void BuildUpgradePool()
    {
        ...
        allUpgrades.Add(new UpgradeOption(
            "Vacuum Field",
            "+0.2 XP / pickup collection radius",
        ...
        allUpgrades.Add(new UpgradeOption(
            "Field Medic",
            "+25% health pickup healing",
            UpgradeType.HealthPickupHealing,
            0.25f
        ));
        ...
        allUpgrades.Add(new UpgradeOption(
            ...
            UpgradeType.HealthPickupDropChance,
            0.03f
        ));
    }
    ...
    private void ApplyUpgrade(UpgradeOption upgrade)
    {
        ...
        switch (upgrade.Type)
        {
            ...
            case UpgradeType.HealthPickupHealing:
                if (playerStats != null)
                {
            ...
            case UpgradeType.HealthPickupDropChance:
                if (playerStats != null)
                {
